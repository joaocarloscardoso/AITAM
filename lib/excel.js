...
function GenerateWorksheetProcedureMatrix(workbook, fileid, selectedLang){
    ...
    worksheet.columns = [
        ...
        { header: 'Folder1', key: 'folder1', width: 40 },
        { header: 'Folder2', key: 'folder2', width: 40 },
        { header: 'WorkProgramFolder', key: 'wpfolder', width: 40 },
        { header: 'Title', key: 'tl', width: 40 },
        { header: 'Type', key: 'tp', width: 40 },	
        { header: 'ProcedureCategory2', key: 'pc2', width: 40 },	
        { header: 'ProcedureCategory3', key: 'pc3', width: 40 },	
        { header: 'ProcedureCategory4', key: 'pc4', width: 40 },	
        { header: 'ProcedureCategory5', key: 'pc5', width: 40 },	
        { header: 'ProcedureCategory6', key: 'pc6', width: 40 },	
        { header: 'ProcedureCategory7', key: 'pc7', width: 40 },	
        { header: 'ProcedureCategory8', key: 'pc8', width: 40 },	
        { header: 'ProcedureCategory9', key: 'pc9', width: 40 },	
        { header: 'ProcedureCategory10', key: 'pc10', width: 40 },	
        { header: 'ProcedureCategory11', key: 'pc11', width: 40 },	
        { header: 'ProcedureMultiSelectCategory1', key: 'pcm1', width: 40 },	
        { header: 'ProcedureMultiSelectCategory2', key: 'pcm2', width: 40 },	
        { header: 'ProcedureMultiSelectCategory3', key: 'pcm3', width: 40 },	
        { header: 'ProcedureMultiSelectCategory4', key: 'pcm4', width: 40 },	
        { header: 'ProcedureMultiSelectCategory5', key: 'pcm5', width: 40 },	
        { header: 'ProcedureMultiSelectCategory6', key: 'pcm6', width: 40 },
            ...
            for (var k=0; k<data.Domains[i].Areas[j].Issues.length; k++) {
                for (var l=0; l<data.Domains[i].Areas[j].Issues[k].Procedures.length; l++) {
                    ...
                    var newRec = [
                        ...
                        vFolder2,
                        vDomain,
                        data.Domains[i].Areas[j].Issues[k].Procedures[l].procedure,
                        '',
                        '',
                        '',
                        '',
                        ...
                        '',
                        '',
                        data.Domains[i].Areas[j].Issues[k].Procedures[l].description
                    ];
                    vFolder1='';
                    vFolder2='';
                    // Add an array of rows
    ...
    worksheetObj.columns = [
        ...
        { header: 'Folder1', key: 'folder1', width: 40 },
        { header: 'Folder2', key: 'folder2', width: 40 },
        { header: 'Objective Folder', key: 'wpfolder', width: 40 },
        { header: 'Title', key: 'tl', width: 40 }
    ];
        ...
        for (var j=0; j<data.Domains[i].Areas.length; j++) {
            ...
            for (var k=0; k<data.Domains[i].Areas[j].Issues.length; k++) {
                ...
                var newRec = [
                    ...
                    vFolder2,
                    vDomain,
                    data.Domains[i].Areas[j].Issues[k].objective
                ];
                vFolder1='';
                vFolder2='';
                // Add an array of rows

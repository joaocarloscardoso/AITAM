...
function FindingsForSpecificDomainsAnalysis(fileid, DomainId, selectedLang = credentials.WorkLang) {
    ...
    for (var j=0; j<vSelAreas.length; j++) {
        ...
        //2023-10-25var vDescrArea= '(' + vPlugInId + ') ' + vPointerArea + ' - ' + xpath.select("/Audit/PlugIns/PlugIn/Domain[@nr='" + DomainId + "']/Area[@nr='" + vPointerArea + "']/title/tx[@l='" + selectedLang + "']/@name",doc)[0].nodeValue;

...
//debug
                console.log("/Audit/Cases/Case/cts[@source='AITAM' and @domain='" + vDescrDomain.replace(' - ', ' ').replaceAll("\'","") + "' and @area='" + vDescrArea.replace(' - ', ' ').replaceAll("\'","")  + "'  and @issue='" + tmpIssue.replaceAll("\'","")  + "']/@issue");
//debug
                var NumberOfFindings = xpath.select("/Audit/Cases/Case/cts[@source='AITAM' and @domain='" + vDescrDomain.replace(' - ', ' ').replaceAll("'","\'")  + "' and @area='" + vDescrArea.replace(' - ', ' ').replaceAll("'","\'")  + "'  and @issue='" + tmpIssue.replaceAll("'","\'")  + "']/@issue",doc).length;

...
function LoadFindingMatrix(fileid, FindingId, selectedLang = credentials.WorkLang) {
    var data = fs.readFileSync(fileid, { encoding : 'UTF-8' });
    // Create an XMLDom Element:
    var doc = new Dom().parseFromString(data);
    var tempDescription ='';
...
function LoadRecommendationMatrix(fileid, RecommendationId, selectedLang = credentials.WorkLang) {
    var data = fs.readFileSync(fileid, { encoding : 'UTF-8' });
    // Create an XMLDom Element:
    var doc = new Dom().parseFromString(data);
    var tempDescription ='';
